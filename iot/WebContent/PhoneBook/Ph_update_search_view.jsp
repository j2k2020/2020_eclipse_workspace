...
<div class="container">
  ...
  <form action=Ph_update_proc.jsp method=post>
    ...
    <div class="form-group">
      ...
      <input value=<%=rs.getString("PHnum") %>  type="text" class="form-control" id="PHnum" name="PHnum" >
    </div>
    
    <div class="form-group">
      <label for="memo">메모:</label>
      <input value=<%=rs.getString("memo") %>  type="text" class="form-control" id="memo" name="memo" >
    </div>
